[![Documentation](https://docs.rs/daml-lf/badge.svg)](https://docs.rs/daml-lf/0.3.0)
[![Crate](https://img.shields.io/crates/v/daml-lf.svg)](https://crates.io/crates/daml-lf/0.3.0)
...
```toml
[dependencies]
daml = { version = "0.3.0", features = [ "lf" ] }
```
