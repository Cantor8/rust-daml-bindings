...
pub trait DamlElementVisitor {
    ...
    #[cfg(feature = "full")]
    fn pre_visit_interface_expr(&mut self, iexpr: &DamlInterfaceExpr<'_>) {}
    #[cfg(feature = "full")]
    fn post_visit_interface_expr(&mut self, iexpr: &DamlInterfaceExpr<'_>) {}
    #[cfg(feature = "full")]
    fn pre_visit_query_n_by_key(&mut self, qbk: &DamlQueryNByKey<'_>) {}
    #[cfg(feature = "full")]
    fn post_visit_query_n_by_key(&mut self, qbk: &DamlQueryNByKey<'_>) {}
    #[cfg(feature = "full")]
    fn pre_visit_create_interface(&mut self, ci: &DamlCreateInterface<'_>) {}
    #[cfg(feature = "full")]
    fn post_visit_create_interface(&mut self, ci: &DamlCreateInterface<'_>) {}
    #[cfg(feature = "full")]
    fn pre_visit_exercise_interface(&mut self, ei: &DamlExerciseInterface<'_>) {}
    #[cfg(feature = "full")]
    fn post_visit_exercise_interface(&mut self, ei: &DamlExerciseInterface<'_>) {}
    #[cfg(feature = "full")]
    fn pre_visit_fetch_interface(&mut self, fi: &DamlFetchInterface<'_>) {}
    #[cfg(feature = "full")]
    fn post_visit_fetch_interface(&mut self, fi: &DamlFetchInterface<'_>) {}
}
