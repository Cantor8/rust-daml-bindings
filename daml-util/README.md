[![Documentation](https://docs.rs/daml-util/badge.svg)](https://docs.rs/daml-util/0.3.0)
[![Crate](https://img.shields.io/crates/v/daml-util.svg)](https://crates.io/crates/daml-util/0.3.0)
...
```toml
[dependencies]
daml = { version = "0.3.0", features = [ "util" ] }
```
