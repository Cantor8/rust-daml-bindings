...
//! generated for existing Daml templates using the various functions and macros provided in the [`daml-codegen`](https://docs.rs/daml-codegen/0.4.0) crate.
//!
//! Note also that the [`daml_value`](https://docs.rs/daml-macro/0.4.0/daml_macro/macro.daml_value.html) macro is
...
#![doc(html_root_url = "https://docs.rs/daml-grpc/0.4.0")]
