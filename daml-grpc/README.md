[![Documentation](https://docs.rs/daml-grpc/badge.svg)](https://docs.rs/daml-grpc/0.3.0)
[![Crate](https://img.shields.io/crates/v/daml-grpc.svg)](https://crates.io/crates/daml-grpc/0.3.0)
...
```toml
[dependencies]
daml = { version = "0.3.0", features = [ "grpc" ] }
```
