[![Documentation](https://docs.rs/daml-derive/badge.svg)](https://docs.rs/daml-derive/0.3.0)
[![Crate](https://img.shields.io/crates/v/daml-derive.svg)](https://crates.io/crates/daml-derive/0.3.0)
...
```toml
[dependencies]
daml = { version = "0.3.0", features = [ "derive" ] }
```
