...
//! ### Prelude
//!
//! All of the above Rust type aliases are defined in the [`prelude`](https://docs.rs/daml/0.3.0/daml/prelude/index.html) module of
...
//!
//! [`DamlInt64`]: https://docs.rs/daml/0.3.0/daml/prelude/type.DamlInt64.html
//! [`DamlNumeric`]: https://docs.rs/daml/0.3.0/daml/prelude/type.DamlNumeric.html
//! [`DamlText`]: https://docs.rs/daml/0.3.0/daml/prelude/type.DamlText.html
//! [`DamlBool`]: https://docs.rs/daml/0.3.0/daml/prelude/type.DamlBool.html
//! [`DamlParty`]: https://docs.rs/daml/0.3.0/daml/prelude/struct.DamlParty.html
//! [`DamlDate`]: https://docs.rs/daml/0.3.0/daml/prelude/type.DamlDate.html
//! [`DamlTimestamp`]: https://docs.rs/daml/0.3.0/daml/prelude/type.DamlTimestamp.html
//! [`DamlUnit`]: https://docs.rs/daml/0.3.0/daml/prelude/type.DamlUnit.html
//! [`DamlContractId`]: https://docs.rs/daml/0.3.0/daml/prelude/struct.DamlContractId.html
//! [`DamlList<T>`]: https://docs.rs/daml/0.3.0/daml/prelude/type.DamlList.html
//! [`DamlTextMap<V>`]: https://docs.rs/daml/0.3.0/daml/prelude/type.DamlTextMap.html
//! [`DamlGenMap<K, V>`]: https://docs.rs/daml/0.3.0/daml/prelude/type.DamlGenMap.html
//! [`DamlOptional<T>`]: https://docs.rs/daml/0.3.0/daml/prelude/type.DamlOptional.html
//! [`DamlCreateCommand`]: https://docs.rs/daml-grpc/0.3.0/daml_grpc/data/command/struct.DamlCreateCommand.html
//! [`DamlExerciseCommand`]: https://docs.rs/daml-grpc/0.3.0/daml_grpc/data/command/struct.DamlExerciseCommand.html
//! [`DamlCommandService`]: https://docs.rs/daml-grpc/0.3.0/daml_grpc/service/struct.DamlCommandService.html
//! [`DamlCommandSubmissionService`]: https://docs.rs/daml-grpc/0.3.0/daml_grpc/service/struct.DamlCommandSubmissionService.html
//! [`DamlCreatedEvent`]: https://docs.rs/daml-grpc/0.3.0/daml_grpc/data/event/struct.DamlCreatedEvent.html
//! [`DamlError`]: https://docs.rs/daml-grpc/0.3.0/daml_grpc/data/enum.DamlError.html
//! [`DamlValue`]: https://docs.rs/daml-grpc/0.3.0/daml_grpc/data/value/enum.DamlValue.html
...
#![doc(html_root_url = "https://docs.rs/daml-derive/0.3.0")]
...
/// Function-like procedural macro to generate Rust code for a Daml Daml `dar` ("Daml Archive") files.
///
/// This macro can be used to generate both intermediate and full decomposed type.
///
/// This section describes how to use use the procedural macro to generate both
/// [`RenderMethod::Full`](daml_codegen::generator::RenderMethod::Full) and
/// [`RenderMethod::Intermediate`](daml_codegen::generator::RenderMethod::Intermediate) Rust types from Daml `dar`
/// file.
///
/// Given the following Daml code in module `Fuji.MyModule` of `MyApp` compiled to `MyApp.dar`:
///
/// ```daml
/// template Ping
///   with
...
///
/// ```ignore
/// daml_codegen!(dar_file = r"MyApp.dar", mode = "intermediate");
/// ```
///
...
///         pub mod my_module {
///             use daml::prelude::*;
///             #[DamlTemplate(package_id = r"...", module_name = "Fuji.MyModule")]
///             pub struct Ping {
///                 pub sender: DamlParty,
///                 pub receiver: DamlParty,
///                 pub count: DamlInt64,
...
/// }
/// ```
/// See the above for details generated custom attributes such as [`macro@DamlTemplate`] and [`macro@DamlChoices`].
///
/// To generate [`RenderMethod::Full`](daml_codegen::generator::RenderMethod::Full) Rust types for a
/// `MyDamlApplication.dar` for Daml modules which match the regex `Fuji.*`:
///
/// ```ignore
/// daml_codegen!(dar_file = r"MyApp.dar", module_filter_regex = "Fuji.*", mode = "full");
/// ```
///
/// ### Panics
///
