...
//! ### Prelude
//!
//! All of the above Rust type aliases are defined in the [`prelude`](https://docs.rs/daml/0.4.0/daml/prelude/index.html) module of
...
//!
//! [`DamlInt64`]: https://docs.rs/daml/0.4.0/daml/prelude/type.DamlInt64.html
...
//! [`DamlCommandService`]: https://docs.rs/daml-grpc/0.4.0/daml_grpc/service/struct.DamlCommandService.html
//! [`DamlCommandSubmissionService`]: https://docs.rs/daml-grpc/0.4.0/daml_grpc/service/struct.DamlCommandSubmissionService.html
//! [`DamlCreatedEvent`]: https://docs.rs/daml-grpc/0.4.0/daml_grpc/data/event/struct.DamlCreatedEvent.html
//! [`DamlError`]: https://docs.rs/daml-grpc/0.4.0/daml_grpc/data/enum.DamlError.html
//! [`DamlValue`]: https://docs.rs/daml-grpc/0.4.0/daml_grpc/data/value/enum.DamlValue.html
...
#![doc(html_root_url = "https://docs.rs/daml-derive/0.4.0")]
