[![Documentation](https://docs.rs/daml-codegen/badge.svg)](https://docs.rs/daml-codegen/0.4.0)
[![Crate](https://img.shields.io/crates/v/daml-codegen.svg)](https://crates.io/crates/daml-codegen/0.4.0)
...
- A code generator backend for the of custom attributes and procedural macros defined in
  the [`daml-derive`](https://docs.rs/daml-derive/0.4.0/daml_derive/) crate
- A [`daml_codegen`](https://docs.rs/daml-codegen/0.4.0/daml_codegen/generator/fn.daml_codegen.html) function which is
...
the [`daml`](https://crates.io/crates/daml/0.4.0) crate and enable the `codegen` feature:

```toml
[dependencies]
daml = { version = "0.4.0", features = [ "codegen" ] }
```
